...
pub fn build_containers_section() -> impl Widget {
    section_card(
        Column::new()
                        ...
                        DecoratedBox::new()
                            ...
                            .child(
                                SplitView::new(
                                    // Left panel
                                    DecoratedBox::new()
                                        .style("background-color", Color::from_hex("#EFF6FF"))
                                        .child(
                                            Column::new()
                                                .gap(8.0)
                                                .child(Text::new("Left Panel").class("label"))
                                                .child(
                                                    Text::new("Drag the divider to resize")
                                                        .class("label"),
                                                ),
                                        ),
                                    // Right panel
                                    DecoratedBox::new()
                                        .style("background-color", Color::from_hex("#F0FDF4"))
                                        .child(
                                            Column::new()
                                                .gap(8.0)
                                                .child(Text::new("Right Panel").class("label"))
                                                .child(
                                                    Text::new("Flexible content area")
                                                        .class("label"),
                                                ),
                                        ),
                                )
            ...
            .child(label(
                "Interactive resize, rotate, and move handles (Figma-style).",
            ))
                                        ...
                                        DecoratedBox::new()
                                            ...
                                            .child(
                                                Column::new()
                                                    .gap(4.0)
                                                    .child(
                                                        Text::new("Decorated Card").class("label"),
                                                    )
                                                    .child(
                                                        Text::new("Drag body to move")
                                                            .class("label"),
                                                    )
                                                    .child(
                                                        Text::new("Corners to resize")
                                                            .class("label"),
                                                    )
                                                    .child(
                                                        Text::new("Top handle to rotate")
                                                            .class("label"),
                                                    ),
                                            ),
                                    ),
                        ...
                        DecoratedBox::new()
                            ...
                            .child(
                                TransformBox::new()
                                    ...
                                    .rotatable(false)
                                    .child(TextField::new().placeholder("Type here...")),
                            ),
                    )
                    .child(
                        Row::new()
