...
pub fn build_scroll_section() -> impl Widget {
    section_card(
        Column::new()
                                ...
                                ScrollView::new()
                                    ...
                                    .child(
                                        Column::new()
                                            .gap(8.0)
                                            .child(
                                                Text::new("Line 1: Lorem ipsum dolor sit amet")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 2: Consectetur adipiscing elit")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 3: Sed do eiusmod tempor")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 4: Incididunt ut labore")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 5: Et dolore magna aliqua")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 6: Ut enim ad minim veniam")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 7: Quis nostrud exercitation")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 8: Ullamco laboris nisi")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 9: Ut aliquip ex ea commodo")
                                                    .class("scroll-text"),
                                            )
                                            .child(
                                                Text::new("Line 10: Consequat duis aute irure")
                                                    .class("scroll-text"),
                                            ),
                                    ),
                            )
                ...
                Column::new()
                    ...
                    .child(
                        Stack::new()
                            ...
                            .child(DecoratedBox::new().class("stack-red").class("stack-box-md"))
                            .child(
                                DecoratedBox::new()
            ...
            // New: Carousel
            .child(
                Column::new().gap(8.0).child(label("Carousel")).child(
                    Carousel::new()
                        .show_indicators(true)
                        .child(
                            DecoratedBox::new()
                                .style("background-color", Color::from_hex("#E3F2FD"))
                                .child(Padding::all(24.0).child(
                        ...
                        .child(
                            DecoratedBox::new()
                                .style("background-color", Color::from_hex("#F3E5F5"))
                                .child(Padding::all(24.0).child(
