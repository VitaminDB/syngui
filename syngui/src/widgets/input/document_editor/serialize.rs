...
/// Атрибуты, которые пишутся инлайном: без геометрии. Виды без своего
/// места под `{…}` (параграф, список, код, таблица) обслуживает
/// [`free::serialize_geometry`] — там же, где координаты.
