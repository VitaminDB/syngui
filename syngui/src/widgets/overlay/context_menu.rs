use super::menu::{MenuItem, PopupMenu};
...
impl ContextMenu {
    pub fn new() -> Self {
        ...
        let popup = PopupMenu::new().is_open(menu_open).position(menu_pos);
        Self {
            child: None,
            menu_items: Vec::new(),
            on_select: None,
...
impl Widget for ContextMenu {
    ...
    fn mount(&self, tree: &mut ElementTree, parent_id: ElementId) {
        ...
        let menu_id =
            tree.insert_with_type_id(menu_element, Some(parent_id), self.popup.as_any().type_id());
