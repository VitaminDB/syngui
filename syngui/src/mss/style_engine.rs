    ...
    pub fn cursor(&self) -> Option<CursorIcon> {
        self.get("cursor")
            ...
            .and_then(|s| match s {
                ...
                "ew-resize" | "e-resize" => Some(CursorIcon::EResize),
                "w-resize" => Some(CursorIcon::WResize),
                "ns-resize" | "s-resize" => Some(CursorIcon::SResize),
                "n-resize" => Some(CursorIcon::NResize),
                "nwse-resize" | "se-resize" => Some(CursorIcon::SeResize),
                "nw-resize" => Some(CursorIcon::NwResize),
                "nesw-resize" | "sw-resize" => Some(CursorIcon::SwResize),
